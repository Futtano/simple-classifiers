...
class AdalineGD:
    """A simple class implementation of the ADAptive LIner Neuron classifier.
    ...
    def __init__(self, eta=0.01, n_iter=50, random_state=1, tol=0.01):
        self.eta = eta
        self.n_iter = n_iter
    ...
    def fit(self, X, y):
        """Trains the Adaline classifier to fit the training data
